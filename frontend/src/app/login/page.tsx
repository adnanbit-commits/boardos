        ...
        <div className="bg-[#191D24] border border-[#232830] rounded-2xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            <h1 className="text-[#F0F2F5] font-bold text-2xl mb-1"
              style={{ fontFamily:"'Playfair Display',Georgia,serif", letterSpacing:'-0.02em' }}>Sign in</h1>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[#374151] text-xs">or sign in with email</span>
              <div className="flex-1 h-px bg-[#232830]" />
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-[#6B7280] text-[11px] font-semibold uppercase tracking-widest mb-1.5">Email</label>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-[#6B7280] text-[11px] font-semibold uppercase tracking-widest">Password</label>
                  <button type="button" className="text-[#4F7FFF] text-xs hover:text-blue-300 transition-colors">Forgot?</button>
                </div>
          ...
          <div className="px-8 py-4 border-t border-[#232830] bg-[#13161B] text-center">
            <p className="text-[#6B7280] text-xs">Don't have an account?{' '}
              <Link href="/register" className="text-[#4F7FFF] hover:text-blue-300 font-medium transition-colors">Create one</Link>
            </p>
          </div>
        </div>
      </div>
